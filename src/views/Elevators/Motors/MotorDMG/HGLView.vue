  ...
  <BackGround color1Intensity="40" color2Intensity="60">
    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-6 py-8 min-h-screen">
      ...
      <div v-else>
        ...
        <div
          v-if="headerData"
          class="bg-white shadow-xl rounded-xl p-6 flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8"
        >
          <div class="space-y-2 text-sm text-gray-700">
            <h2 class="text-3xl font-bold text-black">{{ headerData.codigo }}</h2>
              ...
              <tbody class="text-gray-700">
                ...
                >
                  ...
                  <td class="px-4 py-3 whitespace-nowrap sticky right-0 bg-inherit z-0">
                    <RouterLink
                      :to="`/elevators/sem-engrenagem/details/${item.id}`"
