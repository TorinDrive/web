...
const machineLines = ref([
  { title: 'Linha RGL018', tableName: 'mr_rgl018', data: [] },
  { title: 'Linha RGL235', tableName: 'mr_rgl235', data: [] },
  { title: 'Linha RGL303', tableName: 'mr_rgl303', data: [] },
  { title: 'Linha RGL304', tableName: 'mr_rgl304', data: [] },
  { title: 'Linha RGL305', tableName: 'mr_rgl305', data: [] },
  { title: 'Linha RGL306', tableName: 'mr_rgl306', data: [] },
