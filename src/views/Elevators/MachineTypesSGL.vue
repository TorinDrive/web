...
const machineLines = ref([
  ...
  { title: 'Linha SGL23S', tableName: 'mr_sgl23s', data: [] },
  { title: 'Linha SGL23X', tableName: 'mr_sgl23x', data: [] },
  { title: 'Linha SGL206', tableName: 'mr_sgl206', data: [] }, //
  { title: 'Linha SGL306', tableName: 'mr_sgl306', data: [] },
